...
```
  ...
  8. qa           · md-qa-review       → QA verdict + bug issues     (gate)
  9. devops       · md-deploy          → pnpm deploy + close issue
 10. orchestrator → next prioritized story
```
...
`requesting-code-review`, `md-research` to `deep-research`, etc. Don't reimplement them.
